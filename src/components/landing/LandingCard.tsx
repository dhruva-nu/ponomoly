...
/** The card's title block: tagline, logo wordmark, and subtitle. */
function CardHeader() {
  return (
...
/** Name field plus the primary "create game" call to action. */
...
/** The "or join" divider and the room-code entry row. */
...
export default function LandingCard({
  ...
  return (
    <div style={{
      ...
      <CardHeader />
      <NameAndCreate name={name} onName={onName} onCreate={onCreate} hasName={hasName} />
      <JoinSection code={code} onCode={onCode} onJoin={onJoin} hasName={hasName} />
    </div>
  );
}
