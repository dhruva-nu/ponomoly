  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        <button onClick={() => run({ kind: "forceDice", d1, d2 })} style={panelButton("#ffd23c")}>Rig Roll</button>
        <button onClick={() => run({ kind: "clearForceDice" })} style={panelButton("#9fb4d8")}>Clear</button>
      </div>
